...
public class Activity2 extends AppCompatActivity {
    ...
    public static Class getActivityClass(Context context) {
        ...
        /*try {
            ...
            for (ActivityInfo info : packageInfo.activities) {
                Class<?> temp = Class.forName(info.name);
                Log.i("MainActivity50 ", "===========activityList====== " + temp);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }*/
    ...
    public static class ProxyActivity extends AppCompatActivity {
        @Override
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            ...
            tex.setBackgroundColor(0xffffff00);
            setContentView(tex);
        }
    }
}
